...
% \usepackage{graphicx}
\begin{table}[H]
\caption{Daftar Pertanyaan Metode SUS \citep{kaya2019usability}}
\label{tab:SUS}
\centering
\resizebox{\columnwidth}{!}{%
\begin{tabular}{|l|l|}
\hline
R1  & Saya pikir saya ingin menggunakan sistem ini dengan sering.               \\ \hline
R2  & Saya menemukan sistem yang tidak rumit.                                   \\ \hline
R3  & Saya pikir sistemnya mudah digunakan.                                     \\ \hline
R4 & \begin{tabular}[c]{@{}l@{}}Saya pikir saya akan membutuhkan bantuan dari \\ orang teknis untuk dapat menggunakan sistem ini.\end{tabular}    \\ \hline
R5  & Saya menemukan berbagai fungsi dalam sistem ini terintegrasi dengan baik. \\ \hline
R6  & Saya pikir ada terlalu banyak inkonsistensi dalam sistem ini.             \\ \hline
R7 & \begin{tabular}[c]{@{}l@{}}Saya membayangkan bahwa kebanyakan orang akan \\ belajar menggunakan sistem ini dengan sangat cepat.\end{tabular} \\ \hline
R8  & Menurut saya sistem ini sangat rumit untuk digunakan.                     \\ \hline
R9  & Saya merasa sangat percaya diri menggunakan sistem ini.                   \\ \hline
R10 & Saya perlu belajar banyak hal sebelum saya bisa menggunakan sistem ini.   \\ \hline
\end{tabular}%
}
\end{table}

Rumus untuk menghitung skor akhir metode SUS \citep{brooke1996sus}, dapat dilihat dari persamaan berikut.
